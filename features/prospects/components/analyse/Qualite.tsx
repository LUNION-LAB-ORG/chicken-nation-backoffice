...
import { accord, fmtNombre, fmtPct } from "../../utils/prospect-ui";
      ...
      <StatsCard
        ...
        subtitle={
          qualifies > 0
            ...
            : "aucun prospect qualifié sur la période"
        }
        color="purple"
      />
      <StatsCard
        ...
        subtitle={`${fmtNombre(qualifies)} ${accord(qualifies, "prospect qualifié", "prospects qualifiés")}`}
      />
      <StatsCard
