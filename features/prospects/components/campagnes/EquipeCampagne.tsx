    ...
    <Modal isOpen={ouvert} onClose={onFermer} title={`Équipe : ${c.name}`}>
      <div className="space-y-4">
        ...
        <p className="text-xs text-gray-500">
          Un agent retiré rend ses prospects. En répartition automatique, ils sont aussitôt confiés aux autres agents.
        </p>
        ...
        {enCours && (
          <div className="border-t border-gray-100 pt-4 space-y-3">
            <p className="text-sm font-semibold text-gray-800">Répartir les prospects</p>
            <label className="flex items-start gap-2 text-sm text-gray-700 cursor-pointer">
              ...
              Rééquilibrer aussi les prospects déjà confiés mais jamais appelés
            </label>
            <Bouton
