...
export function FiltresContacts({
  ...
  const maj = (partiel: Partial<IContactFiltres>) => onChange({ ...filtres, ...partiel, page: 1 });
  const nbAvances = [
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-3 space-y-3">
      <div className="grid gap-2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr_1fr_auto]">
        ...
        <ChampSelect
          ...
          onChange={(v) => maj({ segment: (v || undefined) as Public | undefined })}
