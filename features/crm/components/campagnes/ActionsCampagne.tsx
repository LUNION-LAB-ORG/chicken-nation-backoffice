...
const TEXTES = {
  lancer: {
    ...
    texte: "Elle prend tous les contacts disponibles de sa population et les répartit dans l'équipe. La population ne pourra plus changer.",
    bouton: "Lancer",
  },
  terminer: {
    titre: "Terminer la campagne ?",
    texte: "Ses chiffres sont figés dans le rapport, et les contacts non convertis quittent leur agent pour la prochaine campagne.",
    bouton: "Terminer",
  },
};
