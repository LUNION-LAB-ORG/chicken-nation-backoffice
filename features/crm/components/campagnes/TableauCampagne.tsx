...
import { STATUT_META, fmtDate } from "../../utils/crm-ui";
      ...
      {c.status === "PLANIFIED" ? (
        ...
        <>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <StatsChartCard title="Où en sont les contacts" subtitle="Statut actuel des ciblés" icon={ListChecks}>
              <BarresRepartition
                couleur="#3B82F6"
                lignes={s.statuts.map((x) => ({ label: STATUT_META[x.statut as ContactStatut]?.label ?? x.statut, nombre: x.nombre }))}
              />
            </StatsChartCard>
          </div>
