...
export default function ScheduleSelector({
  ...
  const [activeTimePickerDay, setActiveTimePickerDay] = useState<string | null>(
    null
  );
    ...
    <div>
      ...
      <div className="bg-gray-50 p-3 rounded-lg">
        ...
        {daysOfWeek.map((day) => (
          ...
          >
            <span className="w-20 text-xs font-medium text-gray-600 dark:text-gray-700">
              {day.label}:
            </span>
      ...
      <div className="text-xs text-gray-500 dark:text-gray-700 mt-1 mb-3">
        Format: heure d&apos;ouverture - heure de fermeture (ex: 08:00-22:00) ou
        Fermé
      </div>
    </div>
  );
