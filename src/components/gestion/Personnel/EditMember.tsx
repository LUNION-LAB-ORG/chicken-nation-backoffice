...
interface EditMemberProps {
  ...
  /** Rendu en PAGE (pas de modal/overlay) — utilisé par la page détail personnel. */
  asPage?: boolean
}

export default function EditMember({ onCancel, onSuccess, existingMember, asPage = false }: EditMemberProps) {
