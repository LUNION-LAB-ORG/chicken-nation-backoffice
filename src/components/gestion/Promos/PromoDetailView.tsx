      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 p-8 max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200     transition-all duration-300 rounded-3xl p-8">
            <div
              className={`w-full h-max-width xl:h-58 lg:h-50 md:h-45 sm:h-50 xs:h-45 rounded-3xl p-6 relative overflow-hidden border-4 ${styles.promoCard}`}
              ref={(el) => {
                if (el) {
                  // Use consistent field names for background and text color
                  el.style.setProperty(
                    "--card-background-color",
                    promo.background_color || promoData.background || "#F17922"
                  );
                  el.style.setProperty(
                    "--card-border-color",
                    promo.text_color || promoData.textColor || "#FFFFFF"
                  );
                  el.style.setProperty(
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-10">
                <div className="bg-white rounded-xl lg:px-2 md:px-1 sm:px-2 sm:py-2 2xl:px-4 xl:px-4 2xl:py-1 py-[1px] px-1 xl:py-[1px] shadow-sm">
                  <span className="text-[#F17922] 2xl:text-xs lg:text-[10px] text-xs font-medium">
              ...
              <div className="relative z-10">
                ...
                <div className="mb-4">
                  ...
                  >
                    <span className="2xl:text-4xl lg:text-3xl xl:text-4xl sm:text-2xl xs:text-xl">
                      {promo.title}
                    </span>
                  </div>{" "}
                  <div
                  ...
                  >
                    <span className="lg:text-xl md:text-lg sm:-md: xs-text:xs">
                      {promo.description}
                    </span>
                  </div>
                </div>
                ...
                <div className="absolute 2xl:top-20 xl:top-22 lg:top-8 md:top-10 sm:top-10 top-8 left-0">
                  ...
                  >
                    ...
                    {formatExpirationDate(
                      promo.expiration_date || promoData.validUntil
                    )}
                  </div>
                </div>
              </div>
              ...
              {promo.coupon_image_url && (
                <div className="absolute -bottom-1 -mt-4 -right-1 w-16 h-16 sm:w-28 sm:h-28 md:w-24 md:h-24 lg:w-35 lg:h-35 xl:w-40 xl:h-40 2xl:w-55 2xl:h-46">
                  <Image
                    ...
                    onError={(e) => {
                      console.warn(
                        "Erreur de chargement de l'image de promo:",
                        promo.coupon_image_url
                      );
            ...
            <div className="p-6 space-y-4">
              {promo.max_total_usage && (
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg   ">
                  <div className="w-12 h-12 bg-[#F17922] rounded-lg flex items-center justify-center text-xl text-white">
                    📊
                  </div>
                  <div className="flex-1 flex justify-between items-center">
                    ...
                    <span className="text-sm font-bold text-gray-900 bg-white px-3 py-1 rounded border border-gray-200">
                      {promo.max_total_usage}
                    </span>
                  </div>
                </div>
              ...
              {promo.max_discount_amount && (
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg  ">
                  ...
                  <div className="flex-1 flex justify-between items-center">
                    ...
                    <span className="text-sm font-bold text-gray-900 bg-white px-3 py-1 rounded border border-gray-200">
                      {promo.max_discount_amount} FCFA
                    </span>
                  </div>
                </div>
              )}
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-xs">
            <div className="px-6 py-4 bg-gray-50 border-b border-gray-200 flex items-center gap-3">
              <div className="p-2 bg-[#F17922] rounded-lg text-lg">🛠️</div>
              <h4 className="text-sm font-bold text-gray-900">
                Actions disponibles
              </h4>
            </div>
            <div className="p-3 sm:p-6 flex flex-col sm:flex-row gap-2 sm:gap-3">
              {onEdit && (
                <HasPermission module={Modules.PROMOTIONS} action={Action.UPDATE}>
                  <button
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4 p-6 bg-linear-to-r from-[#F17922] to-[#FA6345] rounded-2xl text-white shadow-xs relative overflow-hidden group">
            <div className="absolute inset-0 bg-linear-to-r from-white/5 to-white/10 transform -translate-x-full group-hover:translate-x-full transition-transform duration-500"></div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 text-sm">
                Toutes les informations de votre promotion
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-xs hover:shadow-xs transition-shadow">
            ...
            <div className="p-6 grid grid-cols-2 gap-4">
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center text-lg shadow-xs">
                  📅
                </div>
                <div>
              ...
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-gray-900">
                    {formatDate(promo.expiration_date || promoData.validUntil)}
                  </div>
                </div>
              </div>
            ...
            <div className="p-6 grid grid-cols-1 gap-4">
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg  ">
                ...
                <div className="flex-1">
                  ...
                  <span className="text-sm font-bold text-gray-900 font-mono bg-white px-3 py-1 rounded border border-gray-200">
                    {promoData.background || "#F17922"}
                  </span>
                </div>
              </div>
