        ...
        <div className="md:p-6 p-4 pt-2">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full md:px-4 md:py-3 px-3 py-2.5 border border-gray-300 rounded-xl md:text-sm text-xs placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
            />
          </div>
