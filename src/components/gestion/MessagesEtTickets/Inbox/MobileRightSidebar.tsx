    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-300">
          <h3 className="text-lg font-semibold text-orange-500">Informations client</h3>
          <button
            onClick={onClose}
            title="Fermer les informations client"
        ...
        <div className="p-4 overflow-y-auto h-full pb-20">
          ...
          {/* Participants */}
          <div>
            <h4 className="text-base font-semibold text-orange-500 mb-4">Participants</h4>
            <div className="space-y-3">
