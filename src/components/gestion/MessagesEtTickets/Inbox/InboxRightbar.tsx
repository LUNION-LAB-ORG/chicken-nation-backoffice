  ...
  return (
    <div className="h-full md:w-80 w-64 bg-white border-l border-slate-300 overflow-y-auto">
      <div className="md:p-6 p-4">
        <h3 className="lg:text-lg md:text-base text-sm font-regular text-orange-500 md:mb-4 mb-3">
        ...
        {/* Participants */}
        <div>
          <h4 className="lg:text-base md:text-sm text-xs font-regular text-orange-500 md:mb-4 mb-3">
