    ...
    <div className="w-80 bg-gray-50 border-l border-slate-300 flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-6 space-y-8">
        ...
        <div className=' lg:ml-3 ml-0'>
          <h3 className="text-[#F17922] font-semibold text-lg mb-4">Client</h3>
        ...
        {/* Assigné à Section */}
        <div className='lg:ml-3 ml-0'>
          <h3 className="text-[#F17922] font-semibold text-lg mb-4 ">Assigné à</h3>
          <div className="flex items-center space-x-4">
            {ticket.assignee ? (
              <>
        ...
        <div className='lg:ml-3 ml-0'>
          <h3 className="text-[#F17922] font-semibold text-lg mb-4">Informations</h3>
