        ...
        <div className="flex items-end space-x-2">
          ...
          <div className="flex-1">
            <textarea
              ...
              rows={1}
              className="w-full px-4 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none min-h-[40px] max-h-[120px]"
            />
          </div>
          ...
          <button
            ...
            className={`
              ...
              ${(!messageText.trim() && !selectedFile) || isSending
                ...
                : 'bg-primary-500 hover:bg-orange-600'
              }
            `}
