  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2 text-gray-400 hover:text-gray-500 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#F17922] focus:ring-offset-2 rounded-lg"
      >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {!notification.is_read && (
                            <span className="w-2 h-2 bg-[#F17922] rounded-full"></span>
                          )}
                        </div>
                      ...
                      <div className="flex items-center gap-1 ml-2">
                        ...
                        <button
                          ...
                          className={`p-1 rounded-full transition-colors ${
                            notification.is_read
                              ? "text-gray-400 hover:text-[#F17922]"
                              : "text-[#F17922] hover:text-orange-600"
                          }`}
                          title={
                            notification.is_read
